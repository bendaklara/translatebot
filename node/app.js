...
function receivedMessage(event) {
  ...
  if (messageText) {
    ...
    switch (messageText.replace(/[^\w\s]/gi, '').trim().toLowerCase()) {
      ...
      default:
        sendTranslation(senderID, messageText);
    }
...
function sendHiMessage(recipientId) {
  var messageData = {
    ...
    message: {
      text: `
Hello. I am Translate-a-bot. I use Google to translate from English into Hungarian. Try it by typing in any text in English. Ask me nicely to translate for you. Type 'Translate for me, please'
You can also ask me in Hungarian. ;)      
 ...
 *
 */
function sendTranslation(recipientId, messageText) {
console.log(messageText);
translate(messageText, {from: 'en', to: 'hu'}).then(res => {
